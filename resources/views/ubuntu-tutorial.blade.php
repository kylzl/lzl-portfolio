...
<body>
    ...
    <section id="tutorial-content" style="max-width: 900px; margin: 3rem auto; padding: 0 1rem;">
        ...
        <div style="position: relative; margin-bottom: 2rem;">
            <button onclick="copyToClipboard(this)" style="position: absolute; top: 0.5rem; right: 0.5rem; background: rgba(0,255,255,0.2); border: 1px solid var(--accent); color: var(--accent); padding: 0.4rem 0.5rem; cursor: pointer; border-radius: 3px; font-size: 1rem; z-index: 10; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; transition: all 0.3s;">♡</button>
...
CREATE USER 'user01'@'%' IDENTIFIED BY 'P@ssword123';
...
sudo php composer-setup.php --install-dir=/usr/local/bin --filename=composer</pre>
        ...
        <h3 style="color: var(--text); margin-top: 1.5rem; margin-bottom: 0.8rem; font-size: 1rem;">Create Laravel Project</h3>
        <div style="position: relative; margin-bottom: 1.5rem;">
            <button onclick="copyToClipboard(this)" style="position: absolute; top: 0.5rem; right: 0.5rem; background: rgba(0,255,255,0.2); border: 1px solid var(--accent); color: var(--accent); padding: 0.4rem 0.5rem; cursor: pointer; border-radius: 3px; font-size: 1rem; z-index: 10; width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; transition: all 0.3s;">♡</button>
